...
def main():
    ...
    start2 = time.time()
    print(content_brand)
    cl_rc = ColleagueRcsys(wecall_behavior, hcp_market_title, hcp_brand, content_brand, doc_list)
    ...
    xf_final = xf3[["doctorid","rec_cnt","method1","m1_id","method2","m2_id","method3","m3_id","m1_url","m2_url","m3_url","createtime"]]
