...
from format_ import tracker_final_chain

table_name='mh_appwechat_track'

file_name_prefix = 'MH_MSD_AppWeChat_Track*.csv'

month_list = [20200709,20200629,20200521,20200501,20200330,20200227,20200220,20200102,20191226,20191128,20191031,20190926,20190829,20190801,20190701,20190601,20190429]
...
if __name__ == '__main__':
    ...
    for file_ in file_list:
        ...
        tracker_final_chain(file_,converted_file)
