...
def dataPrepare(wechatRaw):
    ...
    patWechatRaw = wechatRaw[wechatRaw["platform"]=="1"]
    ...
    validWechatLog = wechatFilterd[~((wechatFilterd.content_title=="") | (wechatFilterd.content_title.isnull()) | (wechatFilterd.hcp_openid_u_2.isnull()))].reset_index(drop=True)
